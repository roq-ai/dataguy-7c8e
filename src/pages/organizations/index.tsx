...
export function OrganizationListPage(props: OrganizationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getOrganizations({
        relations: ['user', 'valorant_data.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('valorant_data', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'valorant_data',
          header: 'Valorant Data',
          accessorKey: 'valorant_data',
          cell: ({ row: { original: record } }: any) => record?._count?.valorant_data,
        }
      : null,
