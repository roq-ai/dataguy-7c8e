  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Dataguy - Your ultimate destination for comprehensive Valorant Data in the world of esports. Unleash the power of data now!"
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1623820919239-0d0ff10797a1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxWYWxvcmFudHxlbnwwfHx8fDE2ODk5NTI4MjJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@muktasimazlan?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Muktasim Azlan`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Dataguy - Your ultimate destination for comprehensive Valorant Data in the world of esports. Unleash the power of data now!`}
            </Text>
            <Box
